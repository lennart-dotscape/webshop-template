<template>
    <header class="fixed bg-white w-full shadow-sm z-50">
        <nav class="container mx-auto flex justify-between py-8">
            ...
            <ul class="flex flex-row items-center">
                <li class="mr-4 hidden lg:flex">
                    <UiButton :is="'primary'">My account</UiButton>
                </li>
                <li>
                    <NuxtLink to="/">
                ...
                <li class="flex lg:hidden ml-4">
                    <div @click="handleDrawer">
                        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
                    </div>
                </li>
            </ul>
        </nav>
